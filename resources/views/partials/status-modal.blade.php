        ...
        <div class="row g-4">
          ...
          <div class="col-md-9">
            ...
            <div class="row g-4 mb-4">
              <div class="col-md-4">
                <label>Status</label>
                <select id="statusSelect" class="form-select form-dark">
              ...
              <div class="col-md-4">
                ...
                <div id="scoreStars" class="d-flex gap-2 mt-1">
                  @for ($i = 1; $i <= 5; $i++)
                    <i class="bi bi-star fs-4 text-secondary star"
                       data-value="{{ $i }}"></i>
                  @endfor
                </div>
              ...
              <div class="col-md-4">
                <label>Episode</label>
                <input type="number" id="progress" class="form-control form-dark">
              </div>
            </div>
